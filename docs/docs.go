                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/personnel.createRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/personnel.createResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/personnel.expRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/personnel.expResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/personnel.listRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/personnel.listResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/train.createRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/train.createResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/train.expRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/train.expResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/train.listRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/train.listResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "personnel.createRequest": {
            ...
            "properties": {
                ...
                "politicalOutLook": {
                    "description": "社会面貌：0 :普通公民，1：团员，2：党员",
                    "type": "integer"
                },
                "position": {
                    "description": "职称/等级",
        ...
        "personnel.expRequest": {
            "type": "object"
        },
        "personnel.expResponse": {
            "type": "object"
        },
        "personnel.listRequest": {
            "type": "object"
        },
        "personnel.listResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/s_personnel.SPersonnel"
                    }
                }
            }
        },
        "s_personnel.SPersonnel": {
            "type": "object",
            "properties": {
                "bankNum": {
                    "description": "银行卡号",
        ...
        "train.listResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/s_train.STrain"
                    }
                }
            }
        }
